...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{
        padding: "clamp(15px, 5vw, 18px) 10px clamp(15px, 5vw, 18px) 10px ",
      }}
    >
      <Header
        hasShadow={true}
        ...
        <div className="circle-wrapper">
          ...
          {hideBoxes && (
            <>
              ...
              >
                <p className="hero-box-bold-big">
                  {t("HOME.HERO.BOX_LEFT.TEXT")}
                </p>
                <p className="hero-box-semi-small">
                  {t("HOME.HERO.BOX_LEFT.SUB_TEXT")}
                </p>
              </HeroBox>
              ...
              <HeroBox
                ...
                rotate={"6.38deg"}
              >
                <p className="hero-box-medium">
                  {t("HOME.HERO.BOX_RIGHT.TEXT")}
                </p>
                <p className="hero-box-bold-small">
                  {t("HOME.HERO.BOX_RIGHT.SUB_TEXT")}
                </p>
              </HeroBox>
            </>
          )}
