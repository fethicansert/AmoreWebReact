...
const NotificationItem = ({ notification }) => {
  ...
  function getTitle() {
    ...
    if (isPremium && (type === "VISIT_FREE" || type === "LIKE_FREE")) {
  ...
  function getDescription(notification) {
    ...
    if (
      auth?.premiumSubscription &&
      (type === "VISIT_FREE" || type === "LIKE_FREE")
    ) {
      return t(`NOTIFICATION.${type.slice(0, -5)}.DESCRIPTION`, {
        user: userName,
      });
    }

    return t(`NOTIFICATION.${type}.DESCRIPTION`, {
      user: userName,
      jetonQuantity: 100,
    });
  }
  ...
  function getIcon() {
    switch (type) {
      case "CONSUMABLE":
        return (
          <NotificaitonIconWrapper color={colors.iconColor}>
            <DiamondIcon color={colors.backGround3} width="20" height="20" />
          </NotificaitonIconWrapper>
        );

      case "MATCH":
        return (
          <NotificaitonIconWrapper color={colors.brand1}>
            <DoubleHeartIcon
      ...
      case "GIFT":
        return (
          <NotificaitonIconWrapper color={colors.backGround4}>
            <SendGiftIcon color={colors.backGround3} width="20" height="20" />
          </NotificaitonIconWrapper>
        );

      case "AUDIO_CALL_MISSED":
        return (
          <NotificaitonIconWrapper color={colors.fadedText}>
            <MissedCallIcon color={colors.backGround3} />
          </NotificaitonIconWrapper>
        );

      case "LIKE_FREE":
        return (
          <NotificaitonIconWrapper color={colors.brand2}>
            <HeartLineIcon
              width="20"
              height="20"
              color={colors.backGround3}
      ...
      case "VISIT_FREE":
        return (
          <NotificaitonIconWrapper color={colors.blue}>
            <EyeIcon
              width="20"
              height="20"
              color={colors.backGround3}
  ...
  function NotificaitonIconWrapper({ children, color }) {
    return (
      <div
        className="center"
        style={{
