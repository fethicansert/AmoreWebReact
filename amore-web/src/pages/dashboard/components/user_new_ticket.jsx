    ...
    <div>
      ...
      {!questionImage?.image && (
        <div className="dashed-border">
          ...
          <span style={{ color: colors.fadedText, fontSize: ".92rem" }}>
            {" "}
            {t("DASHBOARD.PROFILE.SUPPORT.ADD_IMAGE_PLACEHOLDER")}
          </span>
        </div>
      )}
      ...
      {questionImage?.image && (
        <div
          style={{ maxWidth: "400px", marginTop: "25px", position: "relative" }}
        >
          <div
            onClick={() => setQuestionImage({ image: "", imageFile: "" })}
            style={{
              cursor: "pointer",
              width: "25px",
              height: "25px",
