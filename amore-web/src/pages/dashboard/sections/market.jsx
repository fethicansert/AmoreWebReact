      ...
      <div className="market-header">
        <div className="market-header-container">
          <FlexBox
            ...
            gap="unset"
            alignItems="unset"
            className="market-header-title-contaniner"
          >
      ...
      <div className="market-items-container">
        ...
        <div className="market-items-wrapper">
          <MarkeItem
            ...
            oldPrice={"189,99"}
            newPrice={"124,99"}
            colors={[colors.lowGray, colors.backGround3, colors.backGround3]}
          />
          <MarkeItem
            coin={200}
            discount={43}
            oldPrice={"189,99"}
            newPrice={"174,99"}
            colors={[colors.lowYellow, colors.backGround3, colors.backGround3]}
          />
          <MarkeItem
            coin={500}
            discount={43}
            oldPrice={"189,99"}
            newPrice={"359,99"}
            colors={[colors.lowBlue, colors.backGround3, colors.backGround3]}
          />
          <MarkeItem
            coin={1000}
            discount={43}
            oldPrice={"599,99"}
            newPrice={"799,99"}
            colors={[colors.lowYellow, colors.lowGreen, colors.backGround3]}
          />
          <MarkeItem
            coin={5000}
            discount={43}
            oldPrice={"799,99"}
            newPrice={"2399,99"}
            colors={[colors.lowYellow, colors.lowPurple, colors.backGround3]}
          />
          <MarkeItem
            coin={11000}
            discount={43}
            oldPrice={"799,99"}
            newPrice={"3399,99"}
            colors={[colors.lowYellow, colors.lowBlue, colors.lowGreen]}
          />
        </div>
      </div>
