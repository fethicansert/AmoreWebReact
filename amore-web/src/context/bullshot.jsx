...
const Chat = () => {
    ...
    //SEND TEXT
    async function sendMessage({ text = null, messageType = null, audioUrl = null, audioFile = null, duration = null }) {
        ...
        const optimisticMessage = {
            ...
            type: messageType,
            content: text,
            dataUrl: messageType === 'image' ? image.base64 : messageType === 'audio' ? audioUrl : null,
